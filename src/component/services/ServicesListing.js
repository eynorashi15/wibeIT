              ...
              <div className="row">
                  ...
                  <div className="col-lg-4 col-md-6 col-sm-6">
                      <div className="single-services-box box-2">
                         ...
                         <h3 className="services-heading"><a href={url}>UI/UX Design</a></h3>
                         <p>UI and UX design are crucial for creating successful digital products by designing an attractive and functional interface and providing a seamless and intuitive user experience.</p>
                         <a href={url} className="single-service-btn">Read More</a>
                      </div>
                  </div>
